# Contributing to WildFly Zip Plugin

Welcome to the WildFly Zip Plugin project! We welcome contributions from the community. This guide will walk you through the steps for getting started on our project.
...
## Forking the Project
To contribute, you will first need to fork the [wildfly-zip-plugin](https://github.com/wildfly/wildfly-zip-plugin) repository.

This can be done by looking in the top-right corner of the repository page and clicking "Fork".

The next step is to clone your newly forked repository onto your local workspace. This can be done by going to your newly forked repository, which should be at `https://github.com/USERNAME/wildfly-zip-plugin`.
...
## Issues
The WildFly Zip Plugin project uses GitHub Issues to manage issues. All issues can be found [here](https://github.com/wildfly/wildfly-zip-plugin/issues).
...
First `cd` to the directory where you cloned the project (eg: `cd wildfly-zip-plugin`)

Add a remote ref to upstream, for pulling future updates.
For example:

```
git remote add upstream https://github.com/wildfly/wildfly-zip-plugin
```
...
To build `wildfly-zip-plugin` run:
```bash
mvn clean install
```
...
1. In general, it's good practice to squash all of your commits into a single commit. For larger changes, it's ok to have multiple meaningful commits. If you need help with squashing your commits, feel free to ask us how to do this on your pull request. We're more than happy to help!
  ...
  1. Please include the GitHub issue you worked on in the title of your pull request and in your commit message. For example, for issue [999](https://github.com/wildfly/wildfly-zip-plugin/issues/999), the PR title and commit message should be `[Issue_999] Create a testcase which verifies behaviour of the foo`.

2. Please include the link to the JIRA issue you worked on in the description of the pull request. For example, if your PR adds a fix for [999](https://github.com/wildfly/wildfly-zip-plugin/issues/999), the PR description should contain a link to https://github.com/wildfly/wildfly-zip-plugin/issues/999.
